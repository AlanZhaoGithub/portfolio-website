function AboutSection() {
    ...
    <div id="about" className="flex flex-col h-screen bg-black">
        <div className="flex flex-grow h-3/8 w-screen justify-items-center items-start">
            <h1 className="p-8 sm:p-16 mt-8 ml-8 font-semibold text-gray-200 text-2xl sm:text-4xl lg:text-8xl border-t-4 border-l-4 rounded">
            About me 
            </h1>
        </div>
        <div className="animate-bounce flex flex-col items-center">
            <h1 className="font-bold text-white text-4xl sm:text-8xl mr-12">
            Hi, I&apos;m Alan
            </h1>
        </div>
        <div className="flex flex-grow h-3/8 w-screen justify-items-center items-end flex-row">
            <p className="leading-loose p-8 sm:p-12 ml-8 mr-24 mb-8 font-bold text-gray-200 text-xs text-justify lg:text-2xl border-b-4 border-r-4 rounded">
