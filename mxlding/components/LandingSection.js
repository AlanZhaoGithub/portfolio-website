...
function LandingSection() {
    ...
    return (
        <div id="Content" className="flex flex-grow justify-center items-center bg-black pr-12">
            ...
            justify-items-center place-items-center ring-4 ring-white
            [height:200px] [width:200px] md:[height:450px] md:[width:450px] lg:[height:600px] lg:[width:600px]">
            ...
            className={animated ? "animate-spincircle flex flex-grow" : "flex flex-grow"}>
                ...
                <h1 className="flex grow justify-center text-4xl font-bold text-white">
                    MXLDING
                </h1>
